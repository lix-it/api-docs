...
func main() {
    ...
    req, err := http.NewRequest("GET", "https://api.lix-it.com/v1/person?profile_link=https://www.linkedin.com/in/alfie-lambert", nil)
    if err != nil {
        log.Fatal(err)
    }
...
uri = URI("https://api.lix-it.com/v1/person?profile_link=https://www.linkedin.com/in/alfie-lambert")
