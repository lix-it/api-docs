...
This endpoint looks up organisations by their website domain. It queries an internal database of email domains associated with organisations and returns up to 5 matching organisations.

### HTTP Request

`GET https://api.lix-it.com/v1/organisations/by-domain/{domain}`

### Path Parameters

Parameter | Description
--------- | -----------
domain | The website domain to look up (e.g., "example.com")

</Col>
<Col sticky>

<CodeGroup title="Organisation by Domain" tag="GET" label="/v1/organisations/by-domain/{domain}">

```python
import requests

url = "https://api.lix-it.com/v1/organisations/by-domain/acme.com"
...
```bash {{ title: 'Shell' }}
curl "https://api.lix-it.com/v1/organisations/by-domain/acme.com" \
  -H "Authorization: lixApiKey"
```
