...
Lix imposes a default rate limit of 1 request per 3 seconds. If you exceed this limit, you will receive a 429 "Too Many Requests" error response. When this happens, you should wait at least 3 seconds before retrying your request.

<Note>
To ensure smooth API operation, please implement appropriate request throttling in your application to stay within this rate limit.
</Note>
