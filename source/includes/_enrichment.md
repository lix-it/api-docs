...
```shell
curl "https://api.lix-it.com/v1/person?profile_link=https://www.linkedin.com/in/alfie-lambert" \
  -H "Authorization: lixApiKey"
```
...
Parameter | Description
--------- | -----------
profile_link | The LinkedIn profile URL of the person (e.g., https://www.linkedin.com/in/username)
