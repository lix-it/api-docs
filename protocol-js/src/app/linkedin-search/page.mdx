export const metadata = {
  ...
  description:
    'Explore the LinkedIn Search API's capabilities with detailed guides and examples for searching people, jobs, posts, and Sales Navigator leads, as well as retrieving typeaheads for search facets.',
}
