export const metadata = {
  title: 'Using the API',
  description:
    'This guide covers the essentials of interacting with Lix’s API, including how to pass URLs correctly, handle pagination with sequence IDs, and manage API rate limiting.',
}
